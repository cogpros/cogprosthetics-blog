---
layout: post
title: "Building the Blog (While Writing About Building the Blog)"
date: 2026-02-24
categories: [meta, infrastructure]
description: "The first post. Written while the blog was being built. Why this site exists, what it documents, and who's building it."
audio: /assets/audio/building-the-blog.mp3
---
...
**1. Content strategy feeds itself.**
...
- GitHub Pages (free hosting, version-controlled)
- Custom dark theme, JetBrains Mono, mobile-first
...
- The Jekyll config is being written
- The folder structure is being created
- The first post (this one) is being drafted
- The plan document exists but the blog doesn't yet

By the time you see this, it will exist.

That's the kind of recursion you get when you build with AI agents.

## The Real Goal

Build in public. Document the journey. Help someone in month 9 or 18 of their own TBI recovery who's learning to build differently.

Show that you can still build. You just build with scaffolding now.

And sometimes that scaffolding is an AI agent named after a Norse god who helps you remember what you'd otherwise forget.

---

*This is post #1. More coming.*

*If you're reading this on launch day: welcome. You're early.*
